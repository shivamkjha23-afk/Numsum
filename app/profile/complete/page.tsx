...
const profileTypes: Array<{ value: UserProfileType; label: string; group: "organization" | "academic" | "professional" | "startup" | "other" }> = [
  ...
  { value: "startup_technology_provider", label: "Startup / Technology Provider", group: "startup" },
  { value: "consultant_industry_expert", label: "Consultant / Industry Expert", group: "professional" },
...
function academicLabels(profileType?: UserProfileType) {
  if (profileType === "student") return { institution: "College / university *", discipline: "Branch / department *", interests: "Project interests *", role: "Year / current semester *" };
  return { institution: "Institution *", discipline: "Research area / department *", interests: "Patents, publications, or collaboration interests *", role: "Current research role *" };
}
function professionalTitle(profileType?: UserProfileType) { return profileType === "consultant_industry_expert" ? "2. Consultant / industry expert details" : "2. Engineer / professional details"; }
...
function ProfileCompletionForm() {
  ...
  const academic = academicLabels(form.profileType);
