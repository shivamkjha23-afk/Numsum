...
export const metadata: Metadata = {
  title: "NumSum Labs — Building Possibilities",
  ...
  openGraph: { title: "NumSum Labs", description: "Building Possibilities through industrial innovation collaboration.", images: [brand.ogImage] },
};
