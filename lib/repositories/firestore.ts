...
export async function getCaseStudyComments(caseStudyId: string) { return listCollection<CaseStudyComment>(COLLECTIONS.caseStudyComments, [where("caseStudyId", "==", caseStudyId), where("status", "==", "approved"), limit(100)]).catch(() => []); }
