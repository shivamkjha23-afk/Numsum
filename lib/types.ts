...
export interface ProblemPublicReview extends FirestoreEntity { problemId: string; memberId: string; membershipId?: string; memberName?: string; organizationName?: string; sector?: string; problemTitle?: string; rating: number; reviewText: string; consentForPublicDisplay?: boolean; approvedForPublic?: boolean; adminTags?: string[]; createdAt?: DateLike; updatedAt?: DateLike; }
