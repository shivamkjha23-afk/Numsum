...
export interface CaseStudyComment extends FirestoreEntity { caseStudyId: string; memberId: string; membershipId?: string; memberName?: string; profileType?: string; body: string; status?: "pending" | "approved" | "hidden"; createdAt?: DateLike; updatedAt?: DateLike; }
