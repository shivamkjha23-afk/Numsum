...
export interface PilotTrack extends FirestoreEntity { title: string; problemStatementId: string; summary?: string; milestones?: Array<{ title: string; status?: PlatformStatus; dueAt?: DateLike }>; ownerIds?: string[]; status?: PlatformStatus; visibility?: Visibility; submittedBy?: string; createdBy?: string; reviewedBy?: string; approvedBy?: string; createdAt?: DateLike; updatedAt?: DateLike; reviewedAt?: DateLike; publishedAt?: DateLike; }
...
export interface SuccessStory extends FirestoreEntity { title: string; summary: string; problemStatementId?: string; organizationId?: string; outcomeMetrics?: Record<string, unknown>; status?: PlatformStatus; visibility?: Visibility; submittedBy?: string; createdBy?: string; reviewedBy?: string; approvedBy?: string; createdAt?: DateLike; updatedAt?: DateLike; reviewedAt?: DateLike; publishedAt?: DateLike; }
