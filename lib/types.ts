...
export interface MeetingLog extends FirestoreEntity { id: string; problemStatementId: string; onboardingSessionId?: string; meetingTitle?: string; meetingDate?: DateLike; mode?: "phone" | "video_call" | "in_person" | "email" | "other" | string; attendees?: string[]; summary?: string; decisions?: string; actionItems?: string[]; internalNotes?: string; title?: string; occurredAt?: DateLike; participantIds?: string[]; notes?: string; files?: string[]; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
