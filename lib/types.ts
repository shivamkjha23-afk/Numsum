...
export interface Challenge { id: string; title: string; category?: string; industry?: string; participants?: number; status?: ChallengeStatus; difficulty?: "Emerging" | "Advanced" | "Expert"; timeline?: string; reward?: string; location?: string; createdAt?: unknown; }
export interface Organization { id: string; name: string; industry?: string; location?: string; description?: string; activeChallenges?: number; createdAt?: unknown; }
