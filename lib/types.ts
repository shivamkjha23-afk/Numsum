...
export type PlatformStatus = "draft" | "submitted" | "under_review" | "needs_information" | "onboarded" | "structured" | "active" | "completed" | "published" | "archived" | "rejected" | "member_only" | "public" | "researching" | "competition" | "solved";
...
export interface ResearchPost extends FirestoreEntity { title: string; abstract?: string; summary: string; doi?: string; researchGate?: string; github?: string; pdf?: string; seekCollaboration?: boolean; researchLink?: string; documentLinks?: string[]; supportingFolderLink?: string; problemStatementId?: string; associatedProblemId?: string; author?: string; authors?: string[]; category?: string; tags?: string[]; documentLink?: string; externalReferences?: string[]; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; upvotes?: string[]; bookmarks?: string[]; status?: ResearchStatus; visibility?: Visibility; }
...
export interface ProblemOnboardingSession extends FirestoreEntity { problemStatementId: string; scheduledAt?: DateLike; recordedAt?: DateLike; facilitatorId?: string; participantIds?: string[]; notes?: string; meetingUrl?: string; recordingUrl?: string; questionnaireResponseId?: string; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
export interface QuestionnaireResponse extends FirestoreEntity { problemStatementId: string; templateId?: string; sessionId?: string; respondentId?: string; responses: Record<string, unknown>; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
export interface SOPDocument extends FirestoreEntity { title: string; summary?: string; content?: string; documentLink?: string; problemStatementId?: string; version?: number; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
export interface ResearchItem extends ResearchPost {}
export interface PilotTrack extends FirestoreEntity { title: string; problemStatementId: string; summary?: string; milestones?: Array<{ title: string; status?: PlatformStatus; dueAt?: DateLike }>; ownerIds?: string[]; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
export interface MeetingLog extends FirestoreEntity { title: string; problemStatementId: string; occurredAt?: DateLike; participantIds?: string[]; notes?: string; actionItems?: string[]; files?: string[]; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
...
export interface SuccessStory extends FirestoreEntity { title: string; summary: string; problemStatementId?: string; organizationId?: string; outcomeMetrics?: Record<string, unknown>; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
...
export interface ConstitutionDocument extends FirestoreEntity { title: string; currentVersion?: number; versions?: VersionedDocumentVersion[]; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
export interface ObjectiveTargetDocument extends FirestoreEntity { title: string; objectivePeriod?: string; targets?: Array<{ label: string; metric?: string; targetValue?: string; status?: PlatformStatus }>; currentVersion?: number; versions?: VersionedDocumentVersion[]; status?: PlatformStatus; visibility?: Visibility; createdBy?: string; createdAt?: DateLike; updatedAt?: DateLike; }
