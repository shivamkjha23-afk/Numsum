...
export function CommunityDetailClient({ post }: { post: CommunityPost }) {
  ...
  async function addComment() {
    ...
    if (!content) { setMessage("Write a comment before posting."); return; }
    await addCommunityComment(post, user.uid, content);
    setCommentContent("");
